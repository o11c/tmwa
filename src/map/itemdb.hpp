...
struct item_data *itemdb_exists(sint32 nameid) __attribute__((pure));
...
sint32 itemdb_isequip(sint32);
sint32 itemdb_isequip2(struct item_data *) __attribute__((pure));
sint32 itemdb_isequip3(sint32);
