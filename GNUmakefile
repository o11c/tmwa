...
${BUILD_DIR}/char/char: ${BUILD_DIR}/char/char.o \
 ${BUILD_DIR}/char/inter.o \
 ${BUILD_DIR}/char/int_party.o \
 ${BUILD_DIR}/char/int_storage.o \
 ${BUILD_DIR}/common/core.o \
 ${BUILD_DIR}/common/socket.o \
 ${BUILD_DIR}/common/timer.o \
 ${BUILD_DIR}/common/db.o \
 ${BUILD_DIR}/common/lock.o \
 ${BUILD_DIR}/common/mt_rand.o \
 ${BUILD_DIR}/common/utils.o
${BUILD_DIR}/ladmin/ladmin: ${BUILD_DIR}/ladmin/ladmin.o \
 ${BUILD_DIR}/common/md5calc.o \
 ${BUILD_DIR}/common/core.o \
 ${BUILD_DIR}/common/socket.o \
 ${BUILD_DIR}/common/timer.o \
 ${BUILD_DIR}/common/db.o \
 ${BUILD_DIR}/common/mt_rand.o \
 ${BUILD_DIR}/common/utils.o
${BUILD_DIR}/login/login: ${BUILD_DIR}/login/login.o \
 ${BUILD_DIR}/common/core.o \
 ${BUILD_DIR}/common/socket.o \
 ${BUILD_DIR}/common/timer.o \
 ${BUILD_DIR}/common/db.o \
 ...
 ${BUILD_DIR}/common/md5calc.o \
 ${BUILD_DIR}/common/utils.o
${BUILD_DIR}/map/map: ${BUILD_DIR}/map/map.o \
 ${BUILD_DIR}/map/tmw.o \
 ${BUILD_DIR}/map/magic-interpreter-lexer.o \
 ${BUILD_DIR}/map/magic-interpreter-parser.o \
 ${BUILD_DIR}/map/magic-interpreter-base.o \
 ${BUILD_DIR}/map/magic-expr.o \
 ${BUILD_DIR}/map/magic-stmt.o \
 ${BUILD_DIR}/map/magic.o \
 ${BUILD_DIR}/map/map.o \
 ${BUILD_DIR}/map/chrif.o \
 ${BUILD_DIR}/map/clif.o \
 ${BUILD_DIR}/map/pc.o \
 ${BUILD_DIR}/map/npc.o \
 ${BUILD_DIR}/map/path.o \
 ${BUILD_DIR}/map/itemdb.o \
 ${BUILD_DIR}/map/mob.o \
 ${BUILD_DIR}/map/script.o \
 ${BUILD_DIR}/map/storage.o \
 ${BUILD_DIR}/map/skill.o \
 ${BUILD_DIR}/map/skill-pools.o \
 ${BUILD_DIR}/map/atcommand.o \
 ${BUILD_DIR}/map/battle.o \
 ${BUILD_DIR}/map/trade.o \
 ${BUILD_DIR}/map/party.o \
 ${BUILD_DIR}/common/core.o \
 ${BUILD_DIR}/common/socket.o \
 ${BUILD_DIR}/common/timer.o \
 ${BUILD_DIR}/common/grfio.o \
 ${BUILD_DIR}/common/db.o \
 ${BUILD_DIR}/common/lock.o \
 ${BUILD_DIR}/common/nullpo.o \
 ${BUILD_DIR}/common/mt_rand.o \
 ${BUILD_DIR}/common/md5calc.o \
 ${BUILD_DIR}/common/utils.o
${BUILD_DIR}/tool/eathena-monitor: ${BUILD_DIR}/tool/eathena-monitor.o
${BUILD_DIR}/webserver/main: ${BUILD_DIR}/webserver/main.o \
 ${BUILD_DIR}/webserver/parse.o \
 ${BUILD_DIR}/webserver/generate.o \
 ${BUILD_DIR}/webserver/htmlstyle.o \
 ${BUILD_DIR}/webserver/logs.o \
 ${BUILD_DIR}/webserver/pages/about.o \
 ${BUILD_DIR}/webserver/pages/sample.o \
 ${BUILD_DIR}/webserver/pages/notdone.o
